...
echo "  http://opencost.bocopile.io      - OpenCost Dashboard"
echo "  http://goldilocks.bocopile.io    - Goldilocks VPA"
echo "  http://chaos.bocopile.io         - Chaos Mesh Dashboard"
echo "================================================================="
echo ""
...
echo "  ${INGRESS_IP}  minio.bocopile.io s3.bocopile.io tempo.bocopile.io"
echo "  ${INGRESS_IP}  thanos.bocopile.io opencost.bocopile.io goldilocks.bocopile.io"
echo "  ${INGRESS_IP}  chaos.bocopile.io"
echo ""
